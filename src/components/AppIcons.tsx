...
export const Icon = ({ name, className, style }: { name: string; className?: string; style?: React.CSSProperties }) => {
  ...
  switch (name) {
    ...
    case "truck": return <svg {...props}><circle cx="5" cy="17" r="2" /><circle cx="19" cy="5" r="2" /><path d="M12 17h4.5a3.5 3.5 0 0 0 0-7h-8a3.5 3.5 0 0 1 0-7H12" /></svg>;
    ...
    case "toggleRight": return <svg {...props}><rect width="20" height="12" x="2" y="6" rx="6" /><circle cx="16" cy="12" r="2" /></svg>;
    ...
    case "package": return <svg {...props}><path d="M20 12v10H4V12" /><path d="M2 7h20v5H2z" /><path d="M12 22V7" /><path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z" /><path d="M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z" /></svg>;
    case "projects": return <svg {...props}><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2" /><rect width="6" height="4" x="9" y="3" rx="1" /><path d="M9 12h6" /><path d="M9 16h6" /></svg>;
    ...
    case "gift": return <svg {...props}><polyline points="20 12 20 22 4 22 4 12" /><rect width="20" height="5" x="2" y="7" rx="2" /><path d="M12 22V7" /><path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z" /><path d="M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z" /></svg>;
