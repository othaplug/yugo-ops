        ...
        {open && (
          ...
          >
            ...
            >
              ...
              {!showAIPrompt && (
                <div
                  className="flex items-center gap-2 overflow-x-auto border-b border-[#ffffff]/10 px-4 py-2"
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1 rounded-full px-3 py-1 text-xs font-medium transition-colors ${
                      activeCategory === "All"
                        ...
                        : "bg-[#181818]/10 text-[#181818]/50 opacity-60 hover:bg-[#181818]/20 dark:bg-[#ffffff]/10 dark:text-[#f2f2f2]/50 dark:hover:bg-[#ffffff]/20"
                    }`}
                  >
                    All
                  </button>
              ...
              {showAIPrompt ? (
                <div className="max-h-[60vh] p-4">
                  <div className="rounded-lg bg-[#181818]/5 p-4 dark:bg-[#ffffff]/5">
                    ...
                    <p className="mb-4 text-xs text-[#181818]/70 dark:text-[#f2f2f2]/70">
                ...
                <div className="custom-scrollbar max-h-[60vh] overflow-auto py-2">
                  {/* Recent commands */}
                    ...
                    {getFilteredCommands().length === 0 && (
                      <div className="mx-2 my-8 flex flex-col items-center justify-center text-center">
                        ...
                        <p className="text-sm text-[#181818]/50 dark:text-[#f2f2f2]/50">
                          No commands found for &ldquo;{searchTerm}&rdquo;
                        </p>
                        <button
