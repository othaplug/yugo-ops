...
const tabsListVariants = cva("flex items-center shrink-0", {
  variants: {
    variant: {
      ...
      /** Premium crew: outlined active segment, cream field (see stats time range) */
      yu3Pill: "w-full border border-[var(--yu3-line-subtle)] bg-[var(--yu3-bg-surface-sunken)]/90 p-1 gap-0.5",
    },
    shape: {
      default: "",
      pill: "",
  ...
  "shrink-0 cursor-pointer whitespace-nowrap inline-flex justify-center items-center font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:shrink-0 [&_svg]:text-muted-foreground [&:hover_svg]:text-foreground [&[data-state=active]_svg]:text-foreground",
  {
    variants: {
      variant: {
        ...
        line: "border-b-2 text-muted-foreground border-transparent data-[state=active]:border-primary hover:text-primary data-[state=active]:text-primary data-[state=active]:border-primary",
        yu3Pill:
          "rounded-full text-[10px] font-bold uppercase tracking-[0.1em] text-[var(--yu3-ink-muted)] border border-transparent data-[state=active]:text-[var(--yu3-ink)] data-[state=active]:bg-transparent data-[state=active]:border-[var(--yu3-line-subtle)] data-[state=active]:shadow-none hover:text-[var(--yu3-ink)] [font-family:var(--font-body)]",
      },
      size: {
    ...
    compoundVariants: [
      ...
      { variant: "yu3Pill", size: "md", className: "py-2 px-2" },
    ],
    defaultVariants: {
      variant: "default",
      size: "md",
...
type TabsContextType = {
  variant?: "default" | "button" | "line" | "yu3Pill"
  size?: "lg" | "sm" | "xs" | "md"
}
