      ...
      <>
        ...
        <div className="fixed inset-0 z-[150] flex items-center justify-center p-6" style={{ backgroundColor: CREAM }}>
          <div className="max-w-md w-full text-center animate-fade-up">
            ...
            <h2 className="font-hero text-[30px] sm:text-[36px] font-semibold" style={{ color: WINE }}>Thank you!</h2>
    ...
    <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 overflow-y-auto" style={{ backgroundColor: CREAM }}>
      <div className="max-w-md w-full py-8 animate-fade-up">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-hero text-[30px] sm:text-[36px] font-semibold leading-tight" style={{ color: WINE }}>
            Move Complete!
          </h1>
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          {presets.map((p) => (
            ...
            >
              <div className="text-[22px] font-bold" style={{ color: selectedPreset === p.amount ? WINE : FOREST }}>
