...
export function newClaimAdminEmailHtml(params: {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${GOLD};letter-spacing:1.2px;text-transform:capitalize;margin-bottom:8px;">New Damage Claim</div>
...
export function widgetLeadAdminEmailHtml(params: {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${GOLD};letter-spacing:1.2px;text-transform:capitalize;margin-bottom:8px;">New Widget Lead</div>
...
export function estateBookingAdminEmailHtml(params: {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${GOLD};letter-spacing:1.2px;text-transform:capitalize;margin-bottom:8px;">Estate Booking</div>
...
export function tipReceivedAdminEmailHtml(params: {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${GOLD};letter-spacing:1.2px;text-transform:capitalize;margin-bottom:8px;">Tip Received</div>
