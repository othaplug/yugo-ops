  ...
  const liabilityBody =
    p.serviceType === "local_move" && liabilityTier === "estate"
      ...
      : p.serviceType === "local_move" && liabilityTier === "signature"
        ? `Enhanced declared-value coverage is included with your Signature package, providing full declared value protection up to $50,000 per move. Per-item coverage up to $2,500. ${companyDisplayName} maintains $2,000,000 in commercial liability insurance.`
