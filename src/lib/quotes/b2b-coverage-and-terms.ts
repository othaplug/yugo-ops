...
export const B2B_COVERAGE_TIERS: CoverageTier[] = [
  {
    ...
    limitLabel: "Repair coverage to $30,000",
    deductibleLabel: "Included",
    priceLabel: "Included",
    included: true,
    points: [
      "Careful handling, wall to wall, from the moment we lift your piece to the moment it is placed and positioned",
      "Repair or restoration of damaged items up to $30,000 per shipment. Real coverage, not $0.60-a-pound courier liability",
