...
<table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="margin:36px 0 0;">
  ...
  <tr>
    <td>
      <a href="${url}" style="display:inline-block;background-color:#FFFFFF;color:#000000;padding:16px 40px;font-size:13px;font-weight:700;letter-spacing:0.04em;text-transform:none;text-decoration:none;font-family:${EQ_SANS};border-radius:0;line-height:1;">${label}</a>
    </td>
  </tr>
</table>`;
}
  ...
  const ctaHtml = ctaUrl && ctaLabel
    ...
    <tr>
      <td align="center" style="padding:8px 0 32px;">
        <a href="${ctaUrl}" style="display:inline-block;background-color:${EMAIL_GOLD};color:#0A0806;padding:13px 32px;font-size:13px;font-weight:700;letter-spacing:0.02em;text-transform:none;text-decoration:none;">${ctaLabel}</a>
      </td>
    </tr>
  `
    : "";
        ...
        <tr>
          <td style="padding:28px 24px 32px;font-family:${EQ_SANS};">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="font-size:26px;font-weight:700;letter-spacing:0.02em;text-transform:none;color:${EMAIL_TX};padding-bottom:16px;line-height:1.35;">${headline}</td>
              </tr>
              <tr>
...
export function deliveryNotificationEmail(delivery: {
  ...
  const inner = `
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr><td style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;padding-bottom:8px;">Project Update</td></tr>
      ...
      <tr>
        <td style="background:#1A1A1A;border:1px solid ${EMAIL_BRD};border-radius:8px;padding:20px;margin-bottom:20px;">
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr><td style="font-size:9px;color:${EMAIL_TX3};text-transform:none;font-weight:700;letter-spacing:0.5px;padding-bottom:8px;">Current Status</td></tr>
      ...
      <tr>
        <td align="center" style="padding-bottom:24px;">
          <a href="${trackUrl}" style="display:inline-block;background-color:${EMAIL_GOLD};color:#000000;padding:13px 32px;font-size:12px;font-weight:700;letter-spacing:0.02em;text-transform:none;text-decoration:none;border-radius:0;">Track this project</a>
        </td>
      </tr>
    </table>
  `;
...
function moveStatusBarHtml(status: string, stage?: string | null): string {
  ...
  return `
    ...
    <div style="margin:20px 0 24px">
      <div style="font-size:9px;font-weight:700;color:#666;text-transform:none;letter-spacing:0.5px;margin-bottom:8px">Current Stage</div>
...
export function moveNotificationEmail(move: {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">Your Move Was Updated</div>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding-bottom:24px;">
      <a href="${trackUrl}" style="display:inline-block;background-color:${EMAIL_GOLD};color:#000000;padding:13px 32px;font-size:12px;font-weight:700;letter-spacing:0.02em;text-transform:none;text-decoration:none;border-radius:0;">Track your move</a>
    </td></tr></table>
...
export function trackingLinkEmail(params: {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">Track your move</div>
...
export function invoiceEmail(invoice: {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:16px;">Invoice</div>
    ...
    <div style="background:#1A1A1A;border:1px solid ${EMAIL_BRD};border-radius:8px;padding:20px;text-align:center;margin-bottom:16px;">
      <div style="font-size:9px;color:${EMAIL_TX3};text-transform:none;font-weight:700;margin-bottom:8px;">Amount Due</div>
...
export function changeRequestNotificationEmail(params: {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">Change Request Update</div>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding-bottom:24px;">
      <a href="${portalUrl}" style="display:inline-block;background-color:${EMAIL_GOLD};color:#000000;padding:13px 32px;font-size:12px;font-weight:700;letter-spacing:0.02em;text-transform:none;text-decoration:none;border-radius:0;">Track your move</a>
    </td></tr></table>
  `;
  return emailLayout(inner);
}
...
export function inventoryChangeRequestAdminEmail(params: {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">Inventory Change Request</div>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding-bottom:24px;">
      <a href="${adminUrl}" style="display:inline-block;background-color:${EMAIL_GOLD};color:#000000;padding:13px 32px;font-size:12px;font-weight:700;letter-spacing:0.02em;text-transform:none;text-decoration:none;border-radius:0;">Review in admin</a>
    </td></tr></table>
  `;
  return emailLayout(inner);
}
...
export function inventoryChangeRequestClientEmail(params: {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">Inventory Update</div>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding-bottom:24px;">
      <a href="${portalUrl}" style="display:inline-block;background-color:${EMAIL_GOLD};color:#000000;padding:13px 32px;font-size:12px;font-weight:700;letter-spacing:0.02em;text-transform:none;text-decoration:none;border-radius:0;">View your move</a>
    </td></tr></table>
  `;
  return emailLayout(inner);
}
...
export function extraItemApprovalEmail(params: {
  ...
  const feeDollars = feeCents > 0 ? (feeCents / 100).toFixed(2) : "";
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">Extra Item Approved</div>
...
export function inviteUserEmail(params: {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">You&apos;re Invited</div>
    ...
    <div style="background:#1A1A1A;border:1px solid ${EMAIL_BRD};border-radius:10px;padding:20px;margin-bottom:24px;">
      <div style="font-size:10px;color:${EMAIL_GOLD};text-transform:none;font-weight:700;letter-spacing:2px;margin-bottom:8px;">Your credentials</div>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding-bottom:24px;">
      <a href="${loginUrl}" style="display:inline-block;background-color:${EMAIL_GOLD};color:#000000;padding:13px 32px;font-size:12px;font-weight:700;letter-spacing:0.02em;text-transform:none;text-decoration:none;border-radius:0;">Log in to continue setup</a>
    </td></tr></table>
...
export function invitePartnerEmail(params: {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">You&apos;re Invited as a Partner</div>
...
export function addedToPartnerEmail(params: { contactName: string; companyName: string; loginUrl: string }) {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">Portal access added</div>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding-bottom:24px;">
      <a href="${loginUrl}" style="display:inline-block;background-color:${EMAIL_GOLD};color:#000000;padding:13px 32px;font-size:13px;font-weight:700;letter-spacing:0.02em;text-transform:none;text-decoration:none;border-radius:0;">Log in to partner portal</a>
    </td></tr></table>
  `;
  return emailLayout(inner, loginUrl);
}
...
export function partnerPasswordResetEmail(params: {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">Password Reset</div>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding-bottom:24px;">
      <a href="${loginUrl}" style="display:inline-block;background-color:${EMAIL_GOLD};color:#000000;padding:13px 32px;font-size:12px;font-weight:700;letter-spacing:0.02em;text-transform:none;text-decoration:none;border-radius:0;">Log in to partner portal</a>
    </td></tr></table>
...
export function welcomeEmail(client: { name: string; email: string; portalUrl: string }) {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">Partner Portal Access</div>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding-bottom:24px;">
      <a href="${client.portalUrl}" style="display:inline-block;background-color:${EMAIL_GOLD};color:#000000;padding:13px 32px;font-size:13px;font-weight:700;letter-spacing:0.02em;text-transform:none;text-decoration:none;border-radius:0;">Access your portal</a>
    </td></tr></table>
...
export function referralReceivedEmail(params: { agentName: string; clientName: string; property: string }) {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">Referral Received</div>
    ...
    <div style="background:#1A1A1A;border:1px solid ${EMAIL_BRD};border-radius:10px;padding:20px;margin-bottom:20px;">
      <div style="display:flex;align-items:center;gap:10px">
        <div>
          <div style="font-size:10px;color:${EMAIL_GOLD};text-transform:none;font-weight:700;letter-spacing:2px;margin-bottom:6px;">Status</div>
...
export function crewPortalInviteEmail(params: { name: string; email: string; loginUrl: string; phone: string; pin: string }) {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">Crew Portal Access</div>
    ...
    <div style="width:100%;height:1px;background:linear-gradient(to right,transparent,${EMAIL_GOLD}55,transparent);margin:0 0 20px"></div>
    <div style="background:#1A1A1A;border:1px solid ${EMAIL_BRD};border-radius:10px;padding:20px;margin-bottom:24px;">
      <div style="font-size:10px;color:${EMAIL_GOLD};text-transform:none;font-weight:700;letter-spacing:2px;margin-bottom:8px;">Your login</div>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding-bottom:24px;">
      <a href="${loginUrl}" style="display:inline-block;background-color:${EMAIL_GOLD};color:#000000;padding:13px 32px;font-size:13px;font-weight:700;letter-spacing:0.02em;text-transform:none;text-decoration:none;border-radius:0;">Log in to crew portal</a>
    </td></tr></table>
...
export function essentialConfirmationEmail(p: TierConfirmationParams): string {
  ...
  return emailLayout(`
    <div style="font-size:10px;font-weight:700;color:#C9A962;letter-spacing:3px;text-transform:none;margin-bottom:8px">Move Confirmed</div>
    ...
    <div style="background:#1E1E1E;border:1px solid #2A2A2A;border-radius:10px;padding:20px;margin-bottom:20px">
      <div style="font-size:10px;color:#666;text-transform:none;font-weight:700;letter-spacing:2px;margin-bottom:14px">Move Details</div>
    ...
    <div style="margin-bottom:20px">
      <div style="font-size:10px;color:#C9A962;text-transform:none;font-weight:700;letter-spacing:2px;margin-bottom:10px">What to Expect</div>
    ...
    <div style="margin-bottom:20px">
      <div style="font-size:10px;color:#C9A962;text-transform:none;font-weight:700;letter-spacing:2px;margin-bottom:10px">What to Prepare</div>
      <div style="font-size:13px;color:#B8B5B0;line-height:1.8">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding:4px 0 20px;">
      <a href="${p.trackingUrl}" style="display:inline-block;background-color:#C9A962;color:#000000;padding:13px 32px;font-size:12px;font-weight:700;letter-spacing:0.02em;text-transform:none;text-decoration:none;border-radius:0;">Track Your Move</a>
    </td></tr></table>
...
export function signatureConfirmationEmail(p: TierConfirmationParams): string {
  const dateStr = confirmDateDisplay(p.moveDate);
  return emailLayout(`
    <div style="font-size:10px;font-weight:700;color:#C9A962;letter-spacing:3px;text-transform:none;margin-bottom:8px">Booking Confirmed</div>
    ...
    <div style="background:#1E1E1E;border:1px solid #C9A96233;border-radius:10px;padding:20px;margin-bottom:20px">
      <div style="font-size:10px;color:#C9A962;text-transform:none;font-weight:700;letter-spacing:2px;margin-bottom:14px">Your Signature Move</div>
      <table style="width:100%;font-size:12px;border-collapse:collapse">
        <tr><td style="color:#666;padding:4px 0">Date:</td><td style="color:#FFFFFF;font-weight:600;padding:4px 0;text-align:right">${dateStr} &middot; ${p.timeWindow}</td></tr>
        <tr><td style="color:#666;padding:4px 0">From:</td><td style="color:#FFFFFF;font-weight:600;padding:4px 0;text-align:right">${p.fromAddress}</td></tr>
        <tr><td style="color:#666;padding:4px 0">To:</td><td style="color:#FFFFFF;font-weight:600;padding:4px 0;text-align:right">${p.toAddress}</td></tr>
    ...
    <div style="margin-bottom:20px">
      <div style="font-size:10px;color:#C9A962;text-transform:none;font-weight:700;letter-spacing:2px;margin-bottom:10px">What&apos;s Included</div>
    ...
    <div style="margin-bottom:20px">
      <div style="font-size:10px;color:#C9A962;text-transform:none;font-weight:700;letter-spacing:2px;margin-bottom:10px">Before Your Move</div>
      <div style="font-size:13px;color:#B8B5B0;line-height:1.8">
    ...
    <div style="margin-bottom:20px">
      <div style="font-size:10px;color:#C9A962;text-transform:none;font-weight:700;letter-spacing:2px;margin-bottom:10px">Your Tracking Page</div>
      <div style="font-size:13px;color:#B8B5B0;line-height:1.6">
        Follow your move in real-time on move day:
      </div>
    </div>

    <a href="${p.trackingUrl}" style="display:block;background:#C9A962;color:#000000;padding:13px 32px;border-radius:0;font-size:13px;font-weight:700;letter-spacing:0.02em;text-transform:none;text-decoration:none;margin-bottom:16px;text-align:center">
      Track your move
    </a>
...
export function internalBookingAlertEmail(params: {
  ...
  return emailLayout(`
    <div style="font-size:10px;font-weight:700;color:#2D9F5A;letter-spacing:3px;text-transform:none;margin-bottom:8px">New Booking</div>
...
export function verificationCodeEmail(params: { code: string; purpose: "email_change" | "2fa" }) {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">Verification</div>
    ...
    <div style="background:#1A1A1A;border:1px solid ${EMAIL_BRD};border-radius:12px;padding:28px;text-align:center;margin-bottom:24px;">
      <div style="font-size:10px;color:${EMAIL_GOLD};text-transform:none;font-weight:700;letter-spacing:2px;margin-bottom:16px;">Your Code</div>
...
export function claimConfirmationEmailHtml(claimNumber: string, clientName: string, itemCount: number, totalClaimed: number): string {
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">Claim Received</div>
...
export function claimCreatedByAdminEmailHtml(claimNumber: string, clientName: string, itemCount: number, totalClaimed: number): string {
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">Claim Filed</div>
    <h1 style="font-size:28px;font-weight:700;letter-spacing:0.5px;color:${EMAIL_TX};margin:0 0 12px;">Hi ${escapeHtml(clientName)}</h1>
...
export function claimApprovalEmailHtml(claimNumber: string, clientName: string, approvedAmount: number, resolutionNotes: string): string {
  const notesBlock = resolutionNotes
    ...
    : "";
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">Claim Review Complete</div>
    <h1 style="font-size:28px;font-weight:700;letter-spacing:0.5px;color:${EMAIL_TX};margin:0 0 12px;">Hi ${escapeHtml(clientName)}</h1>
...
export function claimStatusUpdateEmailHtml(claimNumber: string, clientName: string, fromStatus: string, toStatus: string, notes: string | null): string {
  ...
  const inner = `
    <div style="font-size:10px;font-weight:700;color:${EMAIL_GOLD};letter-spacing:3px;text-transform:none;margin-bottom:8px;">Claim Status Update</div>
    <h1 style="font-size:28px;font-weight:700;letter-spacing:0.5px;color:${EMAIL_TX};margin:0 0 12px;">Hi ${escapeHtml(clientName)}</h1>
  ...
  const inner = `
    <tr>
      <td style="padding-bottom:4px;">
        <p style="font-size:11px;font-weight:600;letter-spacing:0.1em;text-transform:none;color:${EMAIL_TX3};margin:0 0 16px;">${escapeHtml(d.projectNumber)} &middot; ${escapeHtml(d.projectName)}</p>
    ...
    <tr>
      <td align="center">
        <a href="${d.portalUrl}" style="display:inline-block;background-color:${EMAIL_GOLD};color:#000000;padding:13px 32px;font-size:12px;font-weight:700;letter-spacing:0.02em;text-transform:none;text-decoration:none;border-radius:0;">View Project</a>
      </td>
    </tr>
