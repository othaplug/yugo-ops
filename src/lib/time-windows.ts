...
export const LEGACY_PARTNER_RECURRING_TIME_WINDOW_OPTIONS: { value: string; label: string }[] = [
  { value: "morning", label: "Morning (8am to 12pm), legacy" },
  { value: "afternoon", label: "Afternoon (12pm to 5pm), legacy" },
  { value: "evening", label: "Evening (5pm to 8pm), legacy" },
  { value: "flexible", label: "Flexible, legacy" },
  { value: "full_day", label: "Full day (8am to 5pm), legacy" },
];
