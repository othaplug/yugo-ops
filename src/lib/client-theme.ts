...
/**
 * Partner portal settings — section / form eyebrows. Brown (var(--font-body)), tight caps.
 */
...
/**
 * Partner settings menu rows & preference card titles. Brown, tight caps (replaces wine serif on those lines).
 */
...
/**
 * Partner settings sign-out label — Brown, tight caps (same rhythm as menu titles).
 */
...
/** Partner settings account card — contact name, Brown tight caps (matches menu row titles). */
