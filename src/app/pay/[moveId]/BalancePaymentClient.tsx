      ...
      <div className="min-h-screen bg-[#0F0F0F] flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <div className="font-serif text-hero font-bold tracking-wider text-[#C9A962]">YUGO</div>
          </div>
          <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-2xl p-8 text-center">
            ...
            <h1 className="text-h2 font-bold text-[#F5F5F3] mb-2">Payment Received</h1>
            <p className="text-title text-[#B8B5B0] leading-relaxed mb-4">
            ...
            <div className="bg-[#0F0F0F] rounded-xl p-4 border border-[#2A2A2A]">
              <div className="text-caption text-[#C9A962] font-bold uppercase tracking-wider mb-2">
                {move.move_code || "Move Details"}
              </div>
              <div className="text-h1 font-bold text-[#2D9F5A]">{fmtPrice(ccTotal)}</div>
              <div className="text-caption text-[#666] mt-1">Charged to your card</div>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-[#0F0F0F] flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="font-serif text-hero font-bold tracking-wider text-[#C9A962]">YUGO</div>
          <div className="text-caption text-[#666] mt-1 uppercase tracking-widest">Balance Payment</div>
        </div>

        {/* Move Summary */}
        <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-2xl p-5 mb-4">
          <div className="text-section font-bold text-[#C9A962] uppercase tracking-widest mb-3">Move Summary</div>
        ...
        {/* Balance Breakdown */}
        <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-2xl p-5 mb-4">
          <div className="text-section font-bold text-[#C9A962] uppercase tracking-widest mb-3">Payment Breakdown</div>
          <div className="space-y-2 text-ui">
            <div className="flex justify-between">
            ...
            <div className="border-t border-[#2A2A2A] pt-2 mt-2 flex justify-between">
              ...
              <span className="text-[#C9A962] font-bold text-h3-sm">{fmtPrice(ccTotal)}</span>
            </div>
          </div>
        </div>
        ...
        {/* Card Form */}
        <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-2xl p-5 mb-4">
          <div className="text-section font-bold text-[#C9A962] uppercase tracking-widest mb-3">Card Details</div>
          <div
          ...
          >
            ...
            {!sdkReady && !error && (
              <div className="flex items-center justify-center py-6">
                ...
                <span className="ml-2 text-ui text-[#666]">Loading payment form…</span>
              </div>
            )}
          </div>
        </div>
        ...
        {/* Error */}
        {error && (
          <div className="px-4 py-3 rounded-xl text-ui font-medium mb-4" style={{ backgroundColor: "rgba(209,67,67,0.1)", color: "#D14343", border: "1px solid rgba(209,67,67,0.3)" }}>
            {error}
          </div>
        )}
        ...
        <button
          ...
          className="w-full py-4 rounded-xl text-title font-bold tracking-wide text-[#0D0D0D] transition-all disabled:opacity-40 disabled:cursor-not-allowed"
        ...
        <div className="flex items-center justify-center gap-2 mt-4 mb-8">
          ...
          <span className="text-label text-[#666]">Secured by Square · 256-bit encryption</span>
        </div>
      </div>
    </div>
  );
