  ...
  <tr><td align="center" style="padding:40px 16px;">
    <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
          ...
          <tr>
            <td width="33%" style="padding-right:8px;">
              <div style="background:#1A1A1A;border:1px solid #2A2A2A;border-radius:10px;padding:16px;text-align:center;">
                ...
                <div style="font-size:11px;color:#666;margin-top:2px;text-transform:none;letter-spacing:0.08em;">Today</div>
              </div>
            </td>
            <td width="33%" style="padding-right:8px;">
              <div style="background:#1A1A1A;border:1px solid #2A2A2A;border-radius:10px;padding:16px;text-align:center;">
                ...
                <div style="font-size:11px;color:#666;margin-top:2px;text-transform:none;letter-spacing:0.08em;">Confirmed</div>
              </div>
            </td>
            <td width="33%">
              <div style="background:#1A1A1A;border:1px solid #2A2A2A;border-radius:10px;padding:16px;text-align:center;">
      ...
      <tr><td style="padding-top:28px;">
        <p style="margin:0 0 12px;font-size:11px;font-weight:700;color:#666;text-transform:none;letter-spacing:0.1em;">Today's Deliveries</p>
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#141414;border:1px solid #222;border-radius:12px;overflow:hidden;">
          <thead>
            <tr style="background:#1A1A1A;">
              <th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;color:#555;text-transform:none;letter-spacing:0.08em;">Ref #</th>
              <th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;color:#555;text-transform:none;letter-spacing:0.08em;">Recipient</th>
              <th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;color:#555;text-transform:none;letter-spacing:0.08em;">Address</th>
              <th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;color:#555;text-transform:none;letter-spacing:0.08em;">Status</th>
              <th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;color:#555;text-transform:none;letter-spacing:0.08em;">Time</th>
            </tr>
          </thead>
      ...
      <!-- Upcoming -->
      <tr><td style="padding-top:28px;">
        <p style="margin:0 0 12px;font-size:11px;font-weight:700;color:#666;text-transform:none;letter-spacing:0.1em;">Upcoming This Week</p>
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#141414;border:1px solid #222;border-radius:12px;overflow:hidden;">
          <thead>
            <tr style="background:#1A1A1A;">
              <th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;color:#555;text-transform:none;letter-spacing:0.08em;">Date</th>
              <th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;color:#555;text-transform:none;letter-spacing:0.08em;">Ref #</th>
              <th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;color:#555;text-transform:none;letter-spacing:0.08em;">Recipient</th>
              <th style="padding:10px 16px;text-align:left;font-size:10px;font-weight:700;color:#555;text-transform:none;letter-spacing:0.08em;">Status</th>
            </tr>
