  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A] font-sans">
      ...
      <main className="max-w-[720px] mx-auto px-4 py-8">
        <h1 className="text-h1 font-bold text-[#1A1A1A] mb-6">Terms of Use</h1>
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">1. Acceptance of Terms</h2>
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">2. Service Description</h2>
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">3. User Responsibilities</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
            You agree to:
          </p>
          <ul className="list-disc pl-6 text-title text-[#666] leading-relaxed mb-3 space-y-1">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">4. Booking and Cancellation</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">5. Liability Limitations</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">6. Insurance and Claims</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">7. Payment Terms</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">8. Dispute Resolution</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">9. Intellectual Property</h2>
          <p className="text-title text-[#666] leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">10. Termination</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">11. Governing Law</h2>
          <p className="text-title text-[#666] leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">12. General</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
