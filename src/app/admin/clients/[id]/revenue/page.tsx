    ...
    <div className="w-full min-w-0 max-w-[min(900px,100%)] mx-auto py-5 md:py-6 animate-fade-up">
      ...
      <div className="mb-2">
        <p className="text-[10px] font-bold tracking-[0.18em] uppercase text-[var(--tx3)]/82 mb-1.5">
          Finance · Client Revenue
        </p>
        <h1 className="admin-page-hero text-[var(--tx)]">{org.name}</h1>
      </div>
      <p className="text-[12px] text-[var(--tx3)] mb-6">
        Revenue and invoices for this client
      </p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        <div className="bg-[var(--card)] border border-[var(--brd)] rounded-xl p-4">
          ...
          <div className="text-lg font-bold font-heading text-[var(--grn)]">
        ...
        <div className="bg-[var(--card)] border border-[var(--brd)] rounded-xl p-4">
          ...
          <div className="text-lg font-bold font-heading text-[var(--red)]">
            {formatCompactCurrency(totalOverdue)}
          </div>
        </div>
        <div className="bg-[var(--card)] border border-[var(--brd)] rounded-xl p-4">
          <div className="text-[9px] font-semibold tracking-wider uppercase text-[var(--tx3)] mb-1">
          ...
          {all.length === 0 ? (
            ...
            all.map((inv) => (
              <Link
                ...
                href={
                  inv.move_id
                    ? getMoveDetailPath({ id: inv.move_id })
                    : "/admin/invoices"
                }
