    ...
    <div className="space-y-6 py-5">
      ...
      <div className="grid grid-cols-3 sm:grid-cols-6 gap-3">
        <div className="p-3 rounded-xl border border-[var(--brd)] bg-[var(--card)]">
          <div className="text-[9px] font-bold tracking-wider capitalize text-[var(--tx3)]/60">Deliveries</div>
          <div className="text-[20px] font-bold text-[var(--tx)] mt-0.5">{d.totalDeliveries}</div>
        </div>
        <div className="p-3 rounded-xl border border-[var(--brd)] bg-[var(--card)]">
          <div className="text-[9px] font-bold tracking-wider capitalize text-[var(--tx3)]/60">Revenue</div>
          <div className="text-[20px] font-bold text-[var(--gold)] mt-0.5">{formatCurrency(d.revenue)}</div>
        </div>
        <div className="p-3 rounded-xl border border-[var(--brd)] bg-[var(--card)]">
          <div className="text-[9px] font-bold tracking-wider capitalize text-[var(--tx3)]/60">Per Delivery</div>
          <div className="text-[20px] font-bold text-[var(--tx)] mt-0.5">{formatCurrency(d.avgRevenuePerDelivery)}</div>
        </div>
        <div className="p-3 rounded-xl border border-[var(--brd)] bg-[var(--card)]">
          <div className="text-[9px] font-bold tracking-wider capitalize text-[var(--tx3)]/60">On-Time</div>
          <div className="text-[20px] font-bold text-emerald-500 mt-0.5">{d.onTimeRate}%</div>
        </div>
        <div className="p-3 rounded-xl border border-[var(--brd)] bg-[var(--card)]">
          <div className="text-[9px] font-bold tracking-wider capitalize text-[var(--tx3)]/60">Satisfaction</div>
          <div className="text-[20px] font-bold text-[var(--gold)] mt-0.5">{d.satisfactionScore != null ? `${d.satisfactionScore}/5` : "-"}</div>
        </div>
        <div className="p-3 rounded-xl border border-[var(--brd)] bg-[var(--card)]">
          <div className="text-[9px] font-bold tracking-wider capitalize text-[var(--tx3)]/60">Damage</div>
