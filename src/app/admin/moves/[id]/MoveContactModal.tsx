    ...
    <ModalOverlay open={open} onClose={onClose} title="Client contact details" maxWidth="md">
      <div className="p-5 space-y-3">
        ...
        <div className="flex gap-2 mt-4">
          ...
          <button type="button" onClick={handleSave} disabled={saving} className="flex-1 py-2 rounded-lg text-[11px] font-semibold bg-[var(--admin-primary-fill)] text-[var(--btn-text-on-accent)] disabled:opacity-50">
