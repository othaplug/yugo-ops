  ...
  return (
    <div className="bg-[var(--card)] border border-[var(--brd)]/50 rounded-lg p-4 transition-colors">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-4 gap-y-2">
        <div>
          <span className="text-[10px] font-medium tracking-widest uppercase text-[var(--tx3)]/88">Balance amount</span>
        ...
        <div>
          <span className="text-[10px] font-medium tracking-widest uppercase text-[var(--tx3)]/88">Payment status</span>
          <div className={`text-[13px] font-bold ${status.color}`}>{status.label}</div>
        </div>
        {move.balance_method && (
          <div>
            <span className="text-[10px] font-medium tracking-widest uppercase text-[var(--tx3)]/88">Method</span>
