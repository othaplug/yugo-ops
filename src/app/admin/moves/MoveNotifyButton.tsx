...
export default function MoveNotifyButton({ move }: { move: any }) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-section font-semibold tracking-wide bg-[var(--bg)] text-[var(--tx)] border border-[var(--brd)] hover:border-[var(--gold)] transition-colors disabled:opacity-50"
    >
