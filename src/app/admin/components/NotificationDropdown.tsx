...
export default function NotificationDropdown() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-[min(380px,calc(100vw-2rem))] max-w-[380px] bg-[var(--bg2)] border border-[var(--brd)] rounded-xl shadow-2xl overflow-hidden z-[9999] animate-fade-up">
          {/* Header */}
