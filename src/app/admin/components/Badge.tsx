...
const BADGE_COLORS: Record<string, string> = {
  ...
  staging: "bg-[var(--bldim)] text-blue-700 dark:text-sky-300 border border-blue-500/20",
  ...
  scheduled: "bg-[var(--bldim)] text-blue-700 dark:text-sky-300 border border-blue-500/20",
  confirmed: "bg-[var(--bldim)] text-blue-700 dark:text-sky-300 border border-blue-500/20",
  ...
  sent: "bg-[var(--bldim)] text-blue-700 dark:text-sky-300 border border-blue-500/20",
  overdue: "bg-[var(--rdim)] text-[var(--red)]",
  draft: "bg-[var(--brd)] text-[#5C5449] dark:text-[#C9C4B8]",
  cancelled: "bg-[var(--brd)] text-[#5C5449] dark:text-[#C9C4B8]",
  archived: "bg-[var(--brd)] text-[#5C5449] dark:text-[#C9C4B8]",
  booked: "bg-[var(--bldim)] text-blue-700 dark:text-sky-300 border border-blue-500/20",
