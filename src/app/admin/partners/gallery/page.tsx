    ...
    <div className="max-w-[1200px] mx-auto px-5 md:px-6 py-5 md:py-6 animate-fade-up">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-3">
        ...
        <div className="flex gap-2">
          <Link href="/admin/deliveries/new?type=gallery" className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-[11px] font-semibold border border-[var(--brd)] text-[var(--tx)] hover:border-[var(--gold)] bg-[var(--card)] transition-all">
