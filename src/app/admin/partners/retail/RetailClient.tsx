          ...
          <div>
            ...
            {clients.length === 0 ? (
              <div className="px-4 py-10 text-center">
                <p className="text-body text-[var(--tx3)]">No retail partners yet.</p>
                <Link href="/admin/clients/new?type=partner&partnerType=retail" className="text-ui font-semibold text-[var(--gold)] hover:underline mt-1 inline-block">
