...
export default function DesignerProjectsPage() {
  return (
    <div className="max-w-[1200px] mx-auto px-5 md:px-6 py-5 md:py-6 animate-fade-up">
      ...
      <h1 className="font-heading text-h2-sm font-bold text-[var(--tx)] mb-3">All Projects</h1>
      <p className="text-ui text-[var(--tx3)] mb-6">Active, completed, and all designer projects</p>
