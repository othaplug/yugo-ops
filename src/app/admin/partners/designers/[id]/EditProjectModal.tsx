      ...
      <form onSubmit={handleSubmit} className="p-5 space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full text-body bg-[var(--bg)] border border-[var(--brd)] rounded-lg px-3 py-2 text-[var(--tx)] focus:border-[var(--gold)] outline-none"
            required
          />
        </div>
        <div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="block text-label font-bold tracking-wider uppercase text-[var(--tx3)] mb-2">Install date</label>
            <input
              type="text"
              value={installDate}
          ...
          <div>
            <label className="block text-label font-bold tracking-wider uppercase text-[var(--tx3)] mb-2">Budget</label>
            <input
              type="text"
              value={budget}
        ...
        <div>
          <label className="block text-label font-bold tracking-wider uppercase text-[var(--tx3)] mb-2">Designer</label>
          <input
            type="text"
            value={designer}
        ...
        <div>
          <label className="block text-label font-bold tracking-wider uppercase text-[var(--tx3)] mb-2">Designer company</label>
          <input
            type="text"
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="block text-label font-bold tracking-wider uppercase text-[var(--tx3)] mb-2">Designer email</label>
            <input
              type="email"
              value={designerEmail}
          ...
          <div>
            <label className="block text-label font-bold tracking-wider uppercase text-[var(--tx3)] mb-2">Designer phone</label>
            <input
              type="tel"
              value={designerPhone}
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full text-body bg-[var(--bg)] border border-[var(--brd)] rounded-lg px-3 py-2 text-[var(--tx)] focus:border-[var(--gold)] outline-none resize-none"
          />
        </div>
        <div className="flex gap-2 pt-2">
          <button
            type="button"
            onClick={onClose}
            className="flex-1 px-4 py-2.5 rounded-lg text-caption font-semibold border border-[var(--brd)] text-[var(--tx)] hover:bg-[var(--bg)]/50 transition-all"
          >
            Cancel
          </button>
          <button
            type="submit"
            className="flex-1 px-4 py-2.5 rounded-lg text-caption font-semibold bg-[var(--gold)] text-[var(--btn-text-on-accent)] hover:bg-[var(--gold2)] transition-all"
          >
            Save
          </button>
        </div>
