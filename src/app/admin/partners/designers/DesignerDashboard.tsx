...
export default function DesignerDashboard({
  ...
  return (
    <div className="max-w-[1200px] mx-auto px-5 md:px-6 py-5 animate-fade-up">
      ...
      {/* Project sections - clickable cards */}
      <div className="space-y-6">
        {projects.map((project) => (
          <Link
            key={project.id}
            href={`/admin/partners/designers/${project.id}`}
            className="block bg-[var(--card)] border border-[var(--brd)] rounded-xl overflow-hidden hover:border-[var(--gold)] transition-all cursor-pointer"
          >
