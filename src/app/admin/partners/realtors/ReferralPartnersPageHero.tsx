...
export function ReferralPartnersPageHero() {
  return (
    <div className="mb-8">
      <p className="text-[10px] font-bold tracking-[0.18em] uppercase text-[var(--tx3)] mb-1.5">Partners</p>
      ...
      <p className="text-[12px] text-[var(--tx3)] mt-1.5 max-w-[640px]">
        Realtors, organizations, and partner agents sending leads into the pipeline.
      </p>
    </div>
  );
}
