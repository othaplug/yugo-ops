...
export default function StatusUpdater({
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-label font-semibold bg-[var(--gold)] text-[var(--btn-text-on-accent)] hover:bg-[var(--gold2)] transition-all active:scale-[.97]"
    >
