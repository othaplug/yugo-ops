...
export default async function DeliveryDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [{ data: org }, { data: orgs }, { data: crews }, stopsResult] = await Promise.all([
  ...
  return <DeliveryDetailClient delivery={delivery} clientEmail={org?.email} organizations={orgs || []} crews={crews || []} stops={stops} />;
}
