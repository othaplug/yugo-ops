      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-[var(--card)] rounded-xl border border-[var(--brd)] p-5">
            <h3 className="text-[length:var(--text-base)] font-bold text-[var(--tx)] mb-3">Claim Details</h3>
          ...
          {(crewName || claim.crew_team) && (
            <div className="bg-[var(--card)] rounded-xl border border-[var(--brd)] p-5">
              <h3 className="text-[length:var(--text-base)] font-bold text-[var(--tx)] mb-2">Crew</h3>
              ...
              return (
                <div key={idx} className="bg-[var(--card)] rounded-xl border border-[var(--brd)] p-5">
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      <h4 className="text-[length:var(--text-base)] font-bold text-[var(--tx)]">{idx + 1}. {item.name}</h4>
          ...
          {isResolved && (
            <div className="bg-[var(--card)] rounded-xl border border-[var(--brd)] p-5">
              <h3 className="text-[length:var(--text-base)] font-bold text-[var(--tx)] mb-3">Resolution</h3>
              <div className="grid grid-cols-2 gap-4 text-[13px]">
                <div>
        ...
        <div className="space-y-6">
          <div className="bg-[var(--card)] rounded-xl border border-[var(--brd)] p-5">
            <h3 className="text-[length:var(--text-base)] font-bold text-[var(--tx)] mb-4">Timeline</h3>
            {timeline.length === 0 ? (
          ...
          {photos.length > 0 && (
            <div className="bg-[var(--card)] rounded-xl border border-[var(--brd)] p-5">
              <h3 className="text-[length:var(--text-base)] font-bold text-[var(--tx)] mb-3">All Photos ({photos.length})</h3>
