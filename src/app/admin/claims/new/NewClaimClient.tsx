  ...
  return (
    <div className="w-full min-w-0 p-4 sm:p-6 max-w-[min(800px,100%)] mx-auto">
      ...
      <div className="bg-[var(--card)] rounded-xl border border-[var(--brd)] p-5 mb-4">
        <h3 className="text-[length:var(--text-base)] font-bold text-[var(--tx)] mb-3">Link to Job</h3>
      ...
      {/* Client Info */}
      <div className="bg-[var(--card)] rounded-xl border border-[var(--brd)] p-5 mb-4">
        <h3 className="text-[length:var(--text-base)] font-bold text-[var(--tx)] mb-3">Client Details</h3>
      ...
      <div className="bg-[var(--card)] rounded-xl border border-[var(--brd)] p-5 mb-4">
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-[length:var(--text-base)] font-bold text-[var(--tx)]">Damaged Items</h3>
          <button
            type="button"
