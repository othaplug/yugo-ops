  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-gradient-to-b from-[#FAF8F5] to-white">
      <div className="max-w-md w-full text-center space-y-5">
        ...
        <h1 className="text-h3-lg font-bold text-[#1A1714]">Something went wrong</h1>
        <p className="text-body text-[#888]">{error.message || "We couldn't load this quote. It may have expired or been removed."}</p>
