...
import {
  buildStandardTrackPreviewMoveMoveDay,
  PREVIEW_TRACK_TOKEN,
...
/** Standard Signature track when `daysUntil === 0`: “Today’s the day” + arrival window + stage bar. */
export default function TrackMovePreviewMoveDayPage() {
  if (!allowClientUiPreview()) notFound();

  const move = buildStandardTrackPreviewMoveMoveDay();

  return (
    <div className="flex flex-col h-screen min-h-0">
      <PreviewChromeBanner variant="move-day" />
