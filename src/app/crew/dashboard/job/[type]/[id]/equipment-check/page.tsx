      ...
      <main className="min-h-screen" style={{ background: BG, fontFamily: "'DM Sans', sans-serif" }}>
        <div className="max-w-[420px] mx-auto px-4 pb-16 pt-[max(1.5rem,env(safe-area-inset-top))]">
          ...
          <p className="text-[13px] leading-relaxed mb-6" style={{ color: MUTED }}>
            Complete this job (including client sign-off) first. Then count what&apos;s on the truck before you head to the next stop or end your day.
          </p>
          <Link
            href={backHref}
    ...
    return (
      <main className="min-h-screen flex items-center justify-center p-4" style={{ background: BG }}>
        <div className="text-center max-w-sm">
          <h1 className="font-hero text-[24px] font-semibold mb-2" style={{ color: INK }}>Equipment check done</h1>
          <p className="text-[13px] mb-6" style={{ color: MUTED }}>This job already has a submitted or skipped equipment check.</p>
          <Link href={backHref} className="text-[13px] font-medium underline underline-offset-2" style={{ color: MUTED }}>
            Back to job
          </Link>
        </div>
      </main>
      ...
      <div className="max-w-[420px] mx-auto px-4 pb-16 pt-[max(1.5rem,env(safe-area-inset-top))]">
        ...
        <div className="mb-6">
          ...
          <p className="text-[12px] mt-1.5" style={{ color: MUTED }}>
            Count what&apos;s on the truck before the next job or your end-of-day report. Dispatch is notified if anything is missing.
          </p>
        </div>
          ...
          return needsBatch ? (
            <div className="mb-4 space-y-3">
              ...
              {([
                ...
                <label key={o.v} className="flex items-center gap-2 text-[12px] cursor-pointer" style={{ color: INK }}>
                  <input
                    type="radio"
                    name="eq-batch"
        ...
        {eqSkipOpen && !equipmentUnavailable ? (
          <div className="mt-4 p-4 rounded-2xl border space-y-3" style={{ borderColor: BORDER, backgroundColor: NOTE_FILL }}>
            ...
            <textarea
              ...
              className="w-full p-2 rounded-lg border text-[12px] outline-none"
