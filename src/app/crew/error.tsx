  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 bg-[#0F0F0F]">
      <div className="max-w-md w-full text-center space-y-5">
        ...
        <h1 className="text-h3-lg font-bold text-white">Something went wrong</h1>
        <p className="text-body text-gray-400">{error.message || "An unexpected error occurred."}</p>
        <div className="flex gap-3 justify-center">
          <button onClick={reset} className="px-4 py-2 rounded-lg text-ui font-semibold bg-[#C9A962] text-black">Try again</button>
          <a href="/crew/dashboard" className="px-4 py-2 rounded-lg text-ui font-semibold border border-gray-700 text-white">Dashboard</a>
        </div>
      </div>
    </div>
  );
