  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A] font-sans">
      ...
      <main className="max-w-[720px] mx-auto px-4 py-8">
        ...
        <p className="text-[var(--text-base)] text-[#666] leading-relaxed mb-6">
        ...
        <section className="mb-8">
          ...
          <p className="text-[var(--text-base)] text-[#666] leading-relaxed mb-3">
          ...
          <ul className="list-disc pl-6 text-[var(--text-base)] text-[#666] leading-relaxed mb-3 space-y-1">
        ...
        <section className="mb-8">
          ...
          <p className="text-[var(--text-base)] text-[#666] leading-relaxed">
        ...
        <section className="mb-8">
          ...
          <ul className="list-none text-[var(--text-base)] text-[#666] leading-relaxed space-y-1">
            <li>Email:{" "}
              <a href="mailto:hello@yugo.com" className="text-[#C9A962] hover:underline">
                hello@yugo.com
              </a>
        ...
        <button
          type="button"
          onClick={() => router.back()}
          className="inline-block mt-8 text-[var(--text-base)] font-semibold text-[#C9A962] hover:underline cursor-pointer"
        >
          ← Back
        </button>
      </main>
