  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A] font-sans">
      ...
      <main className="max-w-[720px] mx-auto px-4 py-8">
        <h1 className="text-h1 font-bold text-[#1A1A1A] mb-6">Privacy Policy</h1>
        <p className="text-title text-[#666] leading-relaxed mb-6">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">1. Information We Collect</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
            We collect information that you provide directly to us and information we obtain automatically when you use our services.
          </p>
          <h3 className="text-h3 font-medium text-[#1A1A1A] mb-2 mt-4">Personal Information</h3>
          <ul className="list-disc pl-6 text-title text-[#666] leading-relaxed mb-3 space-y-1">
          ...
          <h3 className="text-h3 font-medium text-[#1A1A1A] mb-2 mt-4">Location Data</h3>
          <ul className="list-disc pl-6 text-title text-[#666] leading-relaxed mb-3 space-y-1">
            <li>Real-time location when using our tracking features</li>
            <li>Pickup and delivery addresses</li>
            <li>GPS data for route optimization and ETA estimates</li>
          </ul>
          <h3 className="text-h3 font-medium text-[#1A1A1A] mb-2 mt-4">Payment Information</h3>
          <ul className="list-disc pl-6 text-title text-[#666] leading-relaxed mb-3 space-y-1">
          ...
          <h3 className="text-h3 font-medium text-[#1A1A1A] mb-2 mt-4">Photos and Documentation</h3>
          <ul className="list-disc pl-6 text-title text-[#666] leading-relaxed mb-3 space-y-1">
            <li>Photos of inventory, condition reports, and damage documentation</li>
            <li>Sign-off and proof-of-delivery images</li>
          </ul>
          <h3 className="text-h3 font-medium text-[#1A1A1A] mb-2 mt-4">Automatically Collected Information</h3>
          <ul className="list-disc pl-6 text-title text-[#666] leading-relaxed mb-3 space-y-1">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">2. How We Use Your Information</h2>
          <ul className="list-disc pl-6 text-title text-[#666] leading-relaxed mb-3 space-y-1">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">3. Data Sharing</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
          ...
          <p className="text-title text-[#666] leading-relaxed">
            We do not sell your personal information to third parties.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">4. Data Retention</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">5. Your Rights</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">6. Cookies and Tracking</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">7. Children&apos;s Privacy</h2>
          <p className="text-title text-[#666] leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">8. Security</h2>
          <p className="text-title text-[#666] leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">9. International Transfers</h2>
          <p className="text-title text-[#666] leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">10. Contact Us</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
            For questions about this Privacy Policy or to exercise your rights, contact us:
          </p>
          <ul className="list-none text-title text-[#666] leading-relaxed space-y-1">
            <li>Email:{" "}
              <a href="mailto:hello@yugo.com" className="text-[#C9A962] hover:underline">
                hello@yugo.com
              </a>
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">11. Updates to This Policy</h2>
          <p className="text-title text-[#666] leading-relaxed">
        ...
        <button
          type="button"
          onClick={() => router.back()}
          className="inline-block mt-8 text-title font-semibold text-[#C9A962] hover:underline cursor-pointer"
        >
          ← Back
        </button>
      </main>
