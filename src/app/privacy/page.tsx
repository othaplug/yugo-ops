  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A] font-sans">
      ...
      <main className="max-w-[720px] mx-auto px-4 py-8">
        ...
        <p className="text-[length:var(--text-base)] text-[#454545] leading-relaxed mb-6">
        ...
        <section className="mb-8">
          ...
          <p className="text-[length:var(--text-base)] text-[#454545] leading-relaxed mb-3">
          ...
          <ul className="list-disc pl-6 text-[length:var(--text-base)] text-[#454545] leading-relaxed mb-3 space-y-1">
        ...
        <section className="mb-8">
          ...
          <p className="text-[length:var(--text-base)] text-[#454545] leading-relaxed">
        ...
        <section className="mb-8">
          ...
          <ul className="list-none text-[length:var(--text-base)] text-[#454545] leading-relaxed space-y-1">
            <li>Email:{" "}
              <a href="mailto:hello@yugo.com" className="text-[var(--tx)] hover:underline">
                hello@yugo.com
              </a>
        ...
        <button
          type="button"
          onClick={() => router.back()}
          className="inline-block mt-8 text-[length:var(--text-base)] font-semibold text-[var(--tx)] hover:underline cursor-pointer"
        >
          ← Back
        </button>
      </main>
