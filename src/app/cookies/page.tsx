  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A] font-sans">
      ...
      <main className="max-w-[720px] mx-auto px-4 py-8">
        <h1 className="text-h1 font-bold text-[#1A1A1A] mb-6">Cookie Policy</h1>
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">1. What Are Cookies?</h2>
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">2. Essential Cookies</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">3. Analytics Cookies</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">4. Functional Cookies</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">5. How to Manage Cookies</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
            You can control and manage cookies in several ways:
          </p>
          <h3 className="text-h3 font-medium text-[#1A1A1A] mb-2 mt-4">Browser Settings</h3>
          <p className="text-title text-[#666] leading-relaxed mb-3">
          ...
          <h3 className="text-h3 font-medium text-[#1A1A1A] mb-2 mt-4">Opt-Out Tools</h3>
          <p className="text-title text-[#666] leading-relaxed mb-3">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">6. Cookie Duration</h2>
          <p className="text-title text-[#666] leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">7. Updates</h2>
          <p className="text-title text-[#666] leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-h3-lg font-semibold text-[#1A1A1A] mb-3">8. Contact Us</h2>
          <p className="text-title text-[#666] leading-relaxed mb-3">
