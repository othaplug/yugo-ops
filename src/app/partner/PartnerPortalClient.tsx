    ...
    <div className={`min-h-screen ${partnerTheme === "dark" ? "bg-[var(--bg)]" : "bg-[#F5F3F0]"}`} data-theme={partnerTheme}>
      ...
      <header className="bg-[var(--card)]/95 backdrop-blur border-b border-[var(--brd)] px-4 sm:px-6 py-3.5 flex items-center justify-between sticky top-0 z-30 shadow-sm">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[9px] font-bold tracking-[1.5px] capitalize text-[var(--gold)] opacity-60 ml-0.5">BETA</span>
                    ...
                    <>
                      ...
                      >
                        <div className="px-4 pt-3.5 pb-2.5 border-b border-[var(--brd)]/40">
                          <p className="text-[9px] font-bold capitalize tracking-[0.14em] text-[var(--tx3)]/60">BOOK A SERVICE</p>
                        </div>
                        <div className="p-2">
                          <button
                            type="button"
  ...
  return (
    <div className="border-t border-[var(--brd)]/30 pt-6">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
        <div className="text-center">
          <div className="text-[10px] font-bold tracking-[0.14em] capitalize text-[var(--tx3)]/50">This Month</div>
        ...
        <div className="text-center">
          <div className="text-[10px] font-bold tracking-[0.14em] capitalize text-[var(--tx3)]/50">On-Time Rate</div>
          <div className="text-[26px] sm:text-[30px] font-bold text-[#22C55E] mt-1 font-hero">{data?.onTimeRate ?? 100}%</div>
        </div>
        <div className="text-center">
          <div className="text-[10px] font-bold tracking-[0.14em] capitalize text-[var(--tx3)]/50">Satisfaction</div>
  ...
  return (
    <div className="border-t border-[var(--brd)]/30 pt-6 grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="flex flex-col justify-center">
        <div className="text-[10px] font-bold tracking-[0.14em] capitalize text-[var(--tx3)]/50">Total Earned</div>
...
function ReferralForm() {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="text-[10px] font-bold tracking-[0.14em] capitalize text-[var(--tx3)]/50 mb-3">Submit New Referral</div>
...
function MaterialsTab() {
  ...
  return (
    <div>
      <div className="text-[10px] font-bold tracking-[0.14em] capitalize text-[var(--tx3)]/50 mb-4">Marketing Materials</div>
