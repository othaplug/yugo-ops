    ...
    <div className="space-y-5">
      ...
      {loading ? (
        ...
        <div className="text-center py-12 border border-dashed border-[var(--brd)] rounded-xl">
          <h3 className="text-[length:var(--text-base)] font-bold text-[var(--tx)] mb-1">No recurring schedules</h3>
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-[length:var(--text-base)] font-bold text-[var(--tx)] truncate">{s.schedule_name}</span>
                    {s.is_paused && (
