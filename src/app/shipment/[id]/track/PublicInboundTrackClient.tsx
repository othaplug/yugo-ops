    ...
    <div className="min-h-screen bg-[#FAF8F5] text-[var(--tx)] px-4 py-10">
      <div className="max-w-lg mx-auto">
        <div className="flex items-center gap-2 mb-2">
          <ShippingContainer className="text-[var(--tx)]" size={28} weight="regular" aria-hidden />
        ...
        <div className="rounded-2xl border border-[var(--brd)] bg-white p-5 shadow-sm mb-6">
          <div className="flex items-center gap-2 text-sm font-semibold mb-1">
            <Clock size={18} className="text-[var(--tx)]" aria-hidden />
            Status
          </div>
        ...
        {photos.length > 0 && (
          <div className="rounded-2xl border border-[var(--brd)] bg-white p-5 shadow-sm mb-6">
            <div className="flex items-center gap-2 text-sm font-semibold mb-3">
              <ClipboardText size={18} className="text-[var(--tx)]" aria-hidden />
              Inspection photos
            </div>
