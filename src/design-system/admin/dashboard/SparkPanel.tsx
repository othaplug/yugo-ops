...
export const SparkPanel = React.forwardRef<HTMLDivElement, SparkPanelProps>(
  (
    { items, columns = 4, eyebrow, title, rightSlot, className, ...rest },
    ref,
  ) => {
    const grid =
      columns === 4
            ...
            return (
              <Tag
                ...
                className={cn(
                  ...
                  interactive &&
                    "hover:border-[var(--yu3-line)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--yu3-wine)]",
                )}
              >
